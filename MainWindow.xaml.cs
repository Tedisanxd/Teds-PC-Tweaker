...
public partial class MainWindow : Window
{
    ...
    static readonly Dictionary<TweakCategory, (string Title, string Subtitle)> CatInfo = new()
    {
        ...
        [TweakCategory.Display]     = ("Display",     "Monitor rendering, refresh rate and visual fidelity settings."),
        [TweakCategory.Security]    = ("Security",    "Harden the Windows attack surface and reduce exposure."),
    };
